...
public:
	 ...
	 */
	void set_contigs(sContig** contigs);
	void set_contigs(std::vector< sContig*>* v_contig);
...
private:
	sContig** contigs_; /**< Contigs belonging to this cluster. */
