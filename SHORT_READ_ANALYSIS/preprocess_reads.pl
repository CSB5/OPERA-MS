...
sub generateAlignmentUsingBwamem
{
    ...
    $lib_conf = "/home/bertrandd/PROJECT_LINK/OPERA_LG/META_GENOMIC_HYBRID_ASSEMBLY/OPERA_MS_VERSION_TEST/V2.1bis/CRE_513_05/intermediate_files/test_mapping/lib_1.ebconfig";
    $sigma_conf = "/home/bertrandd/PROJECT_LINK/OPERA_LG/META_GENOMIC_HYBRID_ASSEMBLY/OPERA_MS_VERSION_TEST/V2.1bis/CRE_513_05/intermediate_files/test_mapping/sigma.config";
    $command = "${path}bwa mem -t 20 $folder$contigName[ -1 ] - | ${samtoolsDir}samtools view -S -h  -F 0x4 - | /home/bertrandd/PROJECT_LINK/OPERA_LG/META_GENOMIC_HYBRID_ASSEMBLY/OPERA-MS-DEV/OPERA-MS/SHORT_ANALYSIS/src/short_read_analysis $lib_conf $sigma_conf > $folder$outputFile.out 2> $folder$outputFile.err";
    print $command."\n";
    #if($?){
